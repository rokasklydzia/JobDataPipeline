...
async def scrape_indeed():
    ...
    for job in job_listings:
        ...
        # Extract the timestamp of the job posting
        #timestamp_element = await job.querySelector('span.date')
        #timestamp = await page.evaluate('(element) => element.textContent', timestamp_element)
